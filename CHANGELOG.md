...
## [0.4.1](https://github.com/joaodrp/controld-cli/compare/v0.4.0...v0.4.1) - 2026-09-22

### Other

- retry transient fetch failures in spec drift check

## [0.4.0](https://github.com/joaodrp/controld-cli/compare/v0.3.0...v0.4.0) - 2026-08-31

### Added

- *(rule)* add `--comment` support

### Other

- *(reference)* vendor spec update adding rule `comment` field

## [0.3.0](https://github.com/joaodrp/controld-cli/compare/v0.2.0...v0.3.0) - 2026-08-20

### Added

- *(device)* add `device update`

## [0.2.0](https://github.com/joaodrp/controld-cli/compare/v0.1.2...v0.2.0) - 2026-08-19

### Added

- *(device)* add `device list` and `device get`

### Other

- *(roadmap)* defer endpoint schedules to post-1.0
- *(reference)* record profile2 read-back and endpoint schedules
- *(reference)* document bad-path routing hazards
...
- *(readme)* logo renders off crates.io, not just GitHub

## [0.1.0](https://github.com/joaodrp/controld-cli/releases/tag/v0.1.0) - 2026-07-26
