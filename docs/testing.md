...
Exit codes and the retryable set are **public API** ([AGENTS.md](../AGENTS.md), Contracts). Test
...
mocks; they carry every hazard in the API-hazards index ([AGENTS.md](../AGENTS.md)). Sanitize any
