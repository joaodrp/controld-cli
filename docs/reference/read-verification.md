...
**`PK` is the family; `levels[].name` is what you enable.** No derivable suffix rule — strict is bare
...
**Summary counts != list lengths.** `profile.svc.count` said 16; the list returned 18 (16 enabled + 2
